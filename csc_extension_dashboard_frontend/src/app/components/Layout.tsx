  ...
  >
    ...
    {Array.from({ length: 24 }).map((_, i) => {
      ...
      return (
        <line
          key={`sp-${i}`}
          x1={32 + 2.2 * Math.cos(a)}
          y1={39 + 2.2 * Math.sin(a)}
          x2={32 + 8.5 * Math.cos(a)}
          y2={39 + 8.5 * Math.sin(a)}
          stroke={GOV.saffron}
          strokeWidth="0.8"
        />
      );
...
export default function Layout() {
  ...
  const handleMobileOpen = (e: React.MouseEvent<HTMLElement>) =>
  ...
  const mobileMenu = (
    ...
    >
      ...
      <MenuItem
        onClick={() => {
          handleMobileClose();
          handleProfileOpen({ currentTarget: mobileAnchorEl! } as any);
        }}
      >
        <IconButton size="small" sx={{ color: GOV.blue, mr: 1 }}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tooltip title="Currently under development">
          ...
          >
            ...
            <Box
              component="span"
              sx={{ color: alpha(GOV.white, 0.3), mx: 0.5 }}
            >
              |
            </Box>
      ...
      >
        <Toolbar
          sx={{ minHeight: "64px !important", px: { xs: 1.5, sm: 2 }, gap: 1 }}
        >
          {/* Logo / Emblem */}
          <IconButton
            edge="start"
          ...
          >
            ...
            >
              ...
              <Box
                sx={{ display: { xs: "none", lg: "block" }, textAlign: "left" }}
              >
                <Typography
                  sx={{
                    fontSize: "12px",
                ...
                <Typography
                  sx={{ fontSize: "11px", color: "#6b7280", lineHeight: 1.2 }}
                >
                  District Officer
                </Typography>
              </Box>
      ...
      >
        ...
        <Box
          sx={{
            ...
            gap: "6px",
            height: "46px",
            borderLeft: `1px solid ${alpha(GOV.white, 0.15)}`,
          }}
        >
          <Box
            sx={{
